...
- Возможность записи к врачу, отображение свободных окон с учётом текущего времени (просроченные окна не отображаются), отображение занятых окон в расписании врачей другим цветом без возможности записаться на это же время.
